import * as executeModule from '../../../../../v1/actions/availabilityExceptions/create/execute';
...
describe('availabilityExceptions/create', () => {
	...
	it('should call correct endpoint', async () => {
		...
		expect(options.endpoint).toContain('availability_exceptions/create');
	});
});
