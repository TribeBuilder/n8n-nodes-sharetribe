import * as executeModule from '../../../../../v1/actions/availabilityExceptions/delete/execute';
...
describe('availabilityExceptions/delete', () => {
	...
	it('should call correct endpoint', async () => {
		const mockExecuteFunction = createMockExecuteFunction({
			exceptionId: '550e8400-e29b-41d6-a716-446655440000',
			simplify: true,
			options: {},
		});
		...
		expect(options.endpoint).toContain('availability_exceptions/delete');
	});
});
